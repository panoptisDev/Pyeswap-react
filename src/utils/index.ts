...
import IPYESwapRouter from 'config/abi/IPYESwapRouter.json'
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from '@pyeswap/swap-sdk'
...
export function getRouterContract(_: number, library: Web3Provider, account?: string): Contract {
  return getContract(ROUTER_ADDRESS, IPYESwapRouter, getProviderOrSigner(library, account))
}
