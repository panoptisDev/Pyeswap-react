import { ChainId, Currency, currencyEquals, JSBI, Price } from '@pyeswap/swap-sdk'
...
export const usePYEBusdPrice = (): Price | undefined => {
  const pyeBusdPrice = useBUSDPrice(tokens.pye)
  return pyeBusdPrice
}
