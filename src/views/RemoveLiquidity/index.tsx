...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@pyeswap/swap-sdk'
...
export default function RemoveLiquidity({
  ...
  async function onAttemptToApprove() {
   // console.log(pairContract, pair, library, deadline)
      ...
      <AutoColumn gap="sm">
        <RowBetween align="flex-end">
          ...
          <RowFixed gap="4px">
            ...
            <Text bold fontSize="24px" ml="10px">
              {currencyA?.symbol}
            </Text>
          </RowFixed>
        </RowBetween>
        ...
        <Text small textAlign="left" pt="12px" pb='32px' style={{ opacity: 0.4 }}>
        ...
        <SwapModalFooterContainer gap='sm'>
          <RowBetween mb='12px'>
            ...
            <RowFixed>
              ...
              <Text fontSize='14px' bold>{parsedAmounts[Field.LIQUIDITY]?.toSignificant(6)}</Text>
            </RowFixed>
          </RowBetween>
          {pair && (
            <>
            ...
            {!showDetailed && (
              <LightCard>
                ...
                <Flex flexWrap="wrap" justifyContent="space-evenly">
                  <Button variant="secondary" scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '25')}>
                    25%
                  </Button>
                  <Button variant="secondary" scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '50')}>
                    50%
                  </Button>
                  <Button variant="secondary" scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '75')}>
                    75%
                  </Button>
                  <Button variant="secondary" scale="sm" onClick={() => onUserInput(Field.LIQUIDITY_PERCENT, '100')}>
                    Max
                  </Button>
                </Flex>
              </LightCard>
