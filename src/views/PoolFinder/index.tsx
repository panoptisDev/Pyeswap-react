...
import { Currency, ETHER, JSBI, TokenAmount } from '@pyeswap/swap-sdk'
...
const StyledButton = styled(Button).attrs({ variant: 'text'})`
  background: ${({ theme }) => theme.colors.chipBackAlt};
