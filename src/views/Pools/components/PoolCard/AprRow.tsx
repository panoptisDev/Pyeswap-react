...
const AprRow: React.FC<AprRowProps> = ({ pool, stakedBalance, performanceFee = 0 }) => {
  ...
  const tooltipContent = vaultKey
    ? t('APY includes compounding, APR doesn’t. This pool’s APPLE is compounded automatically, so we show APY.')
  ...
  return (
    <Flex alignItems="center" justifyContent="space-between">
      ...
      <TooltipText fontSize='13px' color='textSubtle' ref={targetRef}>{vaultKey ? `${t('APY')}:` : `${t('APR')}:`}</TooltipText>
      {apr || isFinished ? (
