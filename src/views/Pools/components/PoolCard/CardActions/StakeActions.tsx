    ...
    return isStaked ? (
      <Flex justifyContent="space-between" alignItems="center">
        <Flex flexDirection="column">
          <>
            <Balance bold fontSize="26px" decimals={3} value={stakedTokenBalance} />
            {stakingTokenPrice !== 0 && (
          ...
          {reachStakingLimit ? (
            <span ref={targetRef}>
              <IconButton variant="primary" disabled>
                <AddIcon color="textDisabled" width="14px" height="14px" />
              </IconButton>
            </span>
          ) : (
            <IconButton
              ...
              disabled={isFinished}
            >
              <AddIcon color="primary" width="14px" height="14px" />
            </IconButton>
          )}
        </Flex>
