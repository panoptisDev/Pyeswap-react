...
const getChartColors = ({ isChangePositive, theme }) => {

  return isChangePositive
    ? { gradient1: 'transparent', gradient2: 'transparent', stroke: theme.colors.stroke }
    : { gradient1: 'transparent', gradient2: 'transparent', stroke: theme.colors.stroke }
}
...
const LineChart = ({ data, setHoverValue, setHoverDate, isChangePositive, timeWindow }: SwapLineChartProps) => {
  ...
  const colors = getChartColors({ isChangePositive, theme })
      ...
      >
        <defs>
          <linearGradient id="gradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor={theme.colors.topGraph} stopOpacity={0.6} />
            <stop offset="100%" stopColor={theme.colors.bottomGraph} stopOpacity={0} />
          </linearGradient>
        </defs>
        <XAxis
          dataKey="time"
