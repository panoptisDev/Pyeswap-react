      ...
      >
        <defs>
          <linearGradient id="gradient" x1="0" y1="0" x2="0" y2="1">
            <stop offset="5%" stopColor={theme.colors.topGraph} stopOpacity={0.5} />
        ...
        />
        <Area dataKey="value" type="monotone" stroke={theme.colors.stroke} fill="url(#gradient)" strokeWidth={2} />
      </AreaChart>
    </ResponsiveContainer>
  )
}
