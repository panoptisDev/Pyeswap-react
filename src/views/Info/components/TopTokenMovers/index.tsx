    ...
    <CardWrapper to={`/info/token/${tokenData.address}`}>
      <TopMoverCard>
        <Flex>
          ...
          <Box ml="16px">
            <Text color="textSubtle">{tokenData.symbol}</Text>
            <Flex alignItems="center">
              <Text color="textSubtle" fontSize="14px" mr="6px" lineHeight="16px">
...
const TopTokenMovers: React.FC = () => {
  ...
  return (
    <Card my="16px" px='0' style={{ backgroundColor: theme.colors.table }}>
      <Text color="textSubtle" ml="24px">
        {t('Top Movers')}
      </Text>
