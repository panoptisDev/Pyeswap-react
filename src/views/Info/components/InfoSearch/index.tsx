...
import { Text, Input, Flex, Skeleton, useMatchBreakpoints, InputGroup } from 'uikit'
...
import IconComponent from 'uikit/components/Svg/IconComponent'
...
const Search = () => {
  ...
  return (
    <>
      ...
      <Container>
        <InputGroup startIcon={<IconComponent iconName="Search" color="#5F6478" />}>
          <StyledInput
            type="text"
            value={value}
            onChange={(e) => {
